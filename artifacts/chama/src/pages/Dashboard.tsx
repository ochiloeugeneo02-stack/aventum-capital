          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            {summary?.currentGroup && (
              <div className="text-xs text-muted-foreground mt-1">
                {formatCurrency(summary.currentGroup.contributionAmount)} due
              </div>
            )}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Contribute {formatCurrency(summary.currentGroup.contributionAmount)} for Cycle {summary.currentGroup.currentCycle}
              </p>
              <div className="mb-4">
              ...
              {!contributionPaid ? (
                ...
                >
                  ...
                  Pay {formatCurrency(summary.currentGroup.contributionAmount)}
                </Button>
              ) : (
              ...
              {summary.upcomingRecipient ? (
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Will receive {formatCurrency((summary.currentGroup.contributionAmount ?? 0) * (summary.currentGroup.totalMembers ?? 0))}</div>
