...
- **Payments:** Member contribution buttons open a Stripe Payment Element card flow. Backend creates a Stripe PaymentIntent with Aventum metadata, verifies succeeded intents before recording contributions, and blocks the old direct-record endpoint for non-admin users in production.
